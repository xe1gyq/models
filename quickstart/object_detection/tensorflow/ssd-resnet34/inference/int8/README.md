...
[ssd-resnet34-int8-inference.tar.gz](https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_1_0_icx/ssd-resnet34-int8-inference.tar.gz)
...
inference.
```
wget https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_1_0_icx/ssd-resnet34-int8-inference.tar.gz
